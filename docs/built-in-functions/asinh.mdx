...
import TestCode from '!!raw-loader!../../scripts/built-in-functions/asinh.test.mjs';
import ImplementCode from '!!raw-loader!../../scripts/built-in-functions/asinh.mts';
...
<LatexPlot xMin={-3} xMax={3} samples={500} plotFunction={(x) => Math.asinh(x)}>
$$
