...
test('sin with vec2', (t) => {
    t.is(sin(new vec2(0)).x, 0);
    t.is(sin(new vec2(radians(90))).y, 1);
    t.is(sin(new vec2(radians(180))).x, 0);
    t.is(sin(new vec2(radians(270))).y, -1);
    t.is(sin(new vec2(radians(360))).x, 0);
    t.is(sin(new vec2(radians(450))).y, 1);
...
test('sin with vec3', (t) => {
    t.is(sin(new vec3(0)).x, 0);
    t.is(sin(new vec3(radians(90))).y, 1);
    t.is(sin(new vec3(radians(180))).z, 0);
    t.is(sin(new vec3(radians(270))).x, -1);
    t.is(sin(new vec3(radians(360))).y, 0);
...
test('sin with vec4', (t) => {
    t.is(sin(new vec4(0)).x, 0);
    t.is(sin(new vec4(radians(90))).y, 1);
    t.is(sin(new vec4(radians(180))).z, 0);
    t.is(sin(new vec4(radians(270))).w, -1);
    t.is(sin(new vec4(radians(360))).x, 0);
